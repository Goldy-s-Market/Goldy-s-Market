...
import { Search, Plus, MessageCircle, ShoppingCart, Bell, ChevronDown,Grid2X2,Book,Laptop,Shirt,Sofa,User,Package,Heart, Settings, LogOut, Menu} from 'lucide-react';
            ...
            <div className="flex items-center space-x-3">
              ...
              <Link to="/cart">
                <button className="relative p-3 text-gray-600 hover:text-[#7A0019] hover:bg-gray-100 rounded-full transition-all duration-200 hover:scale-110">
                  ...
                  {/* TODO: Replace with actual cart item count from backend */}
                ...
                {profileDropdownOpen && (
                  <div className="absolute top-full right-0 mt-2 w-64 bg-white rounded-2xl shadow-xl border border-gray-100 z-10">
                    ...
                    <div className="p-2">
                      ...
                      <Link to="/purchases" className="w-full flex items-center space-x-3 px-3 py-2 rounded-xl hover:bg-gray-50 transition-colors duration-150">
        ...
        <div className="md:hidden bg-white border-t border-gray-200">
          <div className="px-4 py-4 space-y-3">
            ...
            <div className="flex justify-around pt-2">
              ...
              <Link to="/cart" className="flex flex-col items-center space-y-1 p-2">
