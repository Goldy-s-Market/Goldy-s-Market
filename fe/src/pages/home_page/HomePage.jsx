            ...
            <div id="credibility-section" className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-umn-gold rounded-full flex items-center justify-center mb-4 shadow-md">{/*This is where the credit icon will be */}
                  <i className="text-umn-maroon text-2xl" data-fa-i2svg="">
                    <svg  aria-hidden="true" focusable="false" data-prefix="fas" data-icon="graduation-cap" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 512" data-fa-i2svg="">
              ...
              <div className="flex flex-col items-center">
                <div className="w-16 h-16 bg-umn-gold rounded-full flex items-center justify-center mb-4 shadow-md">{/*This is where the credit icon will be */}
                  <i  className="text-umn-maroon text-2xl" data-fa-i2svg=""><svg aria-hidden="true" focusable="false" data-prefix="fas" data-icon="bolt" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" data-fa-i2svg=""><path fill="currentColor" d="M349.4 44.6c5.9-13.7 1.5-29.7-10.6-38.5s-28.6-8-39.9 1.8l-256 224c-10 8.8-13.6 22.9-8.9 35.3S50.7 288 64 288H175.5L98.6 467.4c-5.9 13.7-1.5 29.7 10.6 38.5s28.6 8 39.9-1.8l256-224c10-8.8 13.6-22.9 8.9-35.3s-16.6-20.7-30-20.7H272.5L349.4 44.6z"></path></svg></i>
                </div>
