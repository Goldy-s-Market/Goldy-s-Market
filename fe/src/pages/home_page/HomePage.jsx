...
function HomePage() {
  return (
    <div className="bg-gray-50  flex flex-col justify-center items-center b-24 min-w-screen">
          ...
          <header id="header" className="px-8 py-6 border-b border-gray-100">
            <div className="flex items-center justify-between">
              ...
              <div className="flex items-center space-x-4">
                <Link to="/login">
                  <button className="text-gray-700 hover:text-umn-maroon font-medium px-4 py-2 rounded-lg transition duration-200 cursor-pointer">Sign In</button>
                </Link>
                <Link to="/login">
                  <button className="bg-umn-maroon hover:bg-red-800 text-white font-medium px-6 py-2 rounded-lg transition duration-200 cursor-pointer">Get Started</button>
                </Link>
              </div>
            </div>
          </header>
            ...
            <div id="search-section" className="max-w-2xl mx-auto mb-16">
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                  ...
                  <i className="text-gray-400 w-5 h-5" data-fa-i2svg="">
